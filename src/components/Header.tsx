          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={profileMenuRef}>
              {user ? (
                  ...
                  {isProfileMenuOpen && (
                    <div className="absolute right-0 top-12 w-56 bg-[var(--card-bg)] border border-[var(--border)] rounded-xl shadow-xl overflow-hidden z-50">
                      ...
                      <div className="border-t border-[var(--border)] py-2">
                        <button onClick={handleSignOut} className="flex items-center gap-3 px-4 py-2 w-full text-left text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                ...
                <Link href="/login" className="px-4 py-2 bg-gradient-to-r from-[var(--primary)] to-purple-600 text-white rounded-xl font-semibold hover:opacity-90 transition-opacity">
                  Login
                </Link>
              )}
            </div>
